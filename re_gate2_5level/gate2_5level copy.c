...
int main()
{
  ...
  10　　　　　　　A   B  ~A  ~B
    ...
    */
    ...
    //     printf("time = %d\n",time);
    //     time++;
    //     printf("0 1 9 ows[0] = %f ows[1] = %f ows[2] = %f ows[3] = %f\n", owseo_command_d[0][1][9].ows[0].Vd, owseo_command_d[0][1][9].ows[1].Vd, owseo_command_d[0][1][9].ows[2].Vd, owseo_command_d[0][1][9].ows[3].Vd);
    //     printf("0 2 9 ows[0] = %f ows[1] = %f ows[2] = %f ows[3] = %f\n", owseo_command_d[0][2][9].ows[0].Vd, owseo_command_d[0][2][9].ows[1].Vd, owseo_command_d[0][2][9].ows[2].Vd, owseo_command_d[0][2][9].ows[3].Vd);
    // }
        /*トリガの設定-----------------------------------------------------------------------------------------------------------------------------------------------------*/
        if (t > 100 && t < 101)
        {
                    ...
                    for (k = 1; k < SEO_COLUMNS; k++) // x
                    {
                        if ((i == 0 && (k % 2 == 0)) || (i == 1 && (k % 2 == 1)))
                        {
                            ...
                            else
                            {
                                seo_command_d[i][j][k].V1 = owseo_DtoC_rtod[j][k].ows[3].Vn;
                                seo_command_d[i][j][k].V2 = owseo_command_d[i][j - 1][k].ows[3].Vn;
                                seo_command_d[i][j][k].V3 = owseo_command_d[i][j][k].ows[0].Vn;
                        ...
                        else
                        {
                            if (j == 1)
                            {
                                seo_command_d[i][j][k].V1 = owseo_command_d[i][j][k].ows[0].Vn;
                                seo_command_d[i][j][k].V2 = owseo_CtoD_d[i][j - 1][k - 1].ows[0].Vn;
                                seo_Pcalc(&seo_command_d[i][j][k], 2, C, Cjs2);
                            }
                            else if (j == SEO_ROWS - 1)
                            {
                                seo_command_d[i][j][k].V1 = owseo_command_d[i][j - 1][k].ows[3].Vn;
                                seo_command_d[i][j][k].V2 = owseo_CtoD_d[i][j - 1][k - 1].ows[0].Vn;
                    ...
                    for (k = 1; k < SEO_COLUMNS; k++) // x
                    {
                        if ((i == 0 && (j % 2 == 0)) || (i == 1 && (j % 2 == 1)))
                        {
                            ...
                            else
                            {
                                seo_command_l[i][j][k].V1 = owseo_DtoC_dtol[j][k].ows[3].Vn;
                                seo_command_l[i][j][k].V2 = owseo_command_l[i][j][k - 1].ows[3].Vn;
                                seo_command_l[i][j][k].V3 = owseo_command_l[i][j][k].ows[0].Vn;
                        ...
                        else
                        {
                            if (k == 1)
                            {
                                seo_command_l[i][j][k].V1 = owseo_command_l[i][j][k].ows[0].Vn;
                                seo_command_l[i][j][k].V2 = owseo_CtoD_l[i][j - 1][k - 1].ows[0].Vn;
                                seo_Pcalc(&seo_command_l[i][j][k], 2, C, Cjs2);
                            }
                            else if (k == SEO_COLUMNS - 1)
                            {
                                seo_command_l[i][j][k].V1 = owseo_command_l[i][j][k - 1].ows[3].Vn;
                                seo_command_l[i][j][k].V2 = owseo_CtoD_l[i][j - 1][k - 1].ows[0].Vn;
                                seo_Pcalc(&seo_command_l[i][j][k], 2, C, Cjs2);
                            }
                            else
                    ...
                    for (k = 1; k < SEO_COLUMNS; k++) // x
                    {
                        if ((i == 0 && (k % 2 == 0)) || (i == 1 && (k % 2 == 1)))
                        {
                            ...
                            else
                            {
                                seo_command_u[i][j][k].V1 = owseo_DtoC_ltou[j][k].ows[3].Vn;
                                seo_command_u[i][j][k].V2 = owseo_command_u[i][j - 1][k].ows[3].Vn;
                                seo_command_u[i][j][k].V3 = owseo_command_u[i][j][k].ows[0].Vn;
                        ...
                        else
                        {
                            if (j == 1)
                            {
                                seo_command_u[i][j][k].V1 = owseo_command_u[i][j][k].ows[0].Vn;
                                seo_command_u[i][j][k].V2 = owseo_CtoD_u[i][j - 1][k - 1].ows[0].Vn;
                                seo_Pcalc(&seo_command_u[i][j][k], 2, C, Cjs2);
                            }
                            else if (j == SEO_ROWS - 1)
                            {
                                seo_command_u[i][j][k].V1 = owseo_command_u[i][j - 1][k].ows[3].Vn;
                                seo_command_u[i][j][k].V2 = owseo_CtoD_u[i][j - 1][k - 1].ows[0].Vn;
                                seo_Pcalc(&seo_command_u[i][j][k], 2, C, Cjs2);
                            }
                            else
                    ...
                    for (k = 1; k < SEO_COLUMNS; k++) // x
                    {
                        if ((i == 0 && (k % 2 == 0)) || (i == 1 && (k % 2 == 1)))
                        {
                            ...
                            else
                            {
                                seo_command_r[i][j][k].V1 = owseo_DtoC_utor[j][k].ows[3].Vn;
                                seo_command_r[i][j][k].V2 = owseo_command_r[i][j][k - 1].ows[3].Vn;
                                seo_command_r[i][j][k].V3 = owseo_command_r[i][j][k].ows[0].Vn;
                        ...
                        else
                        {
                            if (k == 1)
                            {
                                seo_command_r[i][j][k].V1 = owseo_command_r[i][j][k].ows[0].Vn;
                                seo_command_r[i][j][k].V2 = owseo_CtoD_r[i][j - 1][k - 1].ows[0].Vn;
                                seo_Pcalc(&seo_command_r[i][j][k], 2, C, Cjs2);
                            }
                            else if (k == SEO_COLUMNS - 1)
                            {
                                seo_command_r[i][j][k].V1 = owseo_command_r[i][j][k - 1].ows[3].Vn;
                                seo_command_r[i][j][k].V2 = owseo_CtoD_r[i][j - 1][k - 1].ows[0].Vn;
                                seo_Pcalc(&seo_command_r[i][j][k], 2, C, Cjs2);
                            }
                            else
