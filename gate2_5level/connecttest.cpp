    ...
    while (t < 300)
    {
        ...
        for (rep = 0; rep < 5; rep++) // 値の平均化
        {
            ...
            for (i = 0; i < 2; i++)
            {
                ...
                if (i == 0) command_d[i].V3 = command_r[1].Vn;
                else command_d[i].V3 = command_r[0].Vn;
            ...
            for (i = 0; i < 2; i++)
            {
                ...
                if (i == 0) command_r[i].V2 = command_d[1].Vn;
                else command_r[i].V2 = command_d[0].Vn;
